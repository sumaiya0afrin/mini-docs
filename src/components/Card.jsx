...
const Card = ({ data, ref }) => {
  return (
    <motion.div
      ...
      dragConstraints={ref}
      whileDrag={{ scale: 1.2 }}
      className="relative w-60 h-72 rounded-3xl bg-amber-300 p-5 overflow-hidden text-black"
    >
      <FaRegFileAlt />
      <p className="text-sm leading-tight mt-5 font-semibold">{data.title}</p>

      <div className="footer absolute bottom-0  w-full left-0 ">
        <div className="flex justify-between w-full items-center mb-5 py-3 px-5">
        ...
        {!data.downloadIcon && (
          <div className="w-full py-6 bg-amber-500 px-5">
            <progress
